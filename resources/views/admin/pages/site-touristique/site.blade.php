            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex justify-content-between align-items-center w-100">
                        <h4 class="page-title mb-0">Site touristique</h4>
            ...
            <div class="mt-2">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="header-title pb-3 mt-0">Listes des sites touristiques</h5>
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Nouveau Site touristique</h5>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" name="price" class="form-control"
                                            required placeholder="Entrez le prix pour visiter ce site touristique">
                                    </div>

                                    <div class="form-group">
                                        <label>Description</label>
                                        <textarea name="description" class="form-control" rows="3" required
                                            placeholder="Description du site touristique"></textarea>
                                    </div>
